...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.qcinternalaudit.gfyqka"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
tasks.register("fixMainActivity") {
  doLast {
    val file = file("src/main/java/com/example/MainActivity.kt")
    var content = file.readText()
    val startMarker = "\"share_pdf\" to \"مشاركة بصيغة PDF\","
    val endMarker = "@OptIn(ExperimentalAnimationApi::class)"
    val startIndex = content.indexOf(startMarker)
    val endIndex = content.indexOf(endMarker)
    if (startIndex != -1 && endIndex != -1) {
      val prefix = content.substring(0, startIndex + startMarker.length)
...
"""
      ...
      println("MainActivity.kt repaired successfully!")
    } else {
      println("Could not find repair boundaries! startIndex: ${'$'}startIndex, endIndex: ${'$'}endIndex")
    }
  }
}
